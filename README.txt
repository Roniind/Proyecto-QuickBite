...
docs/ → Documentación técnica y análisis SaaS src/ → Código fuente (backend, frontend, configuración) assets/ → Imágenes y recursos visuales database/ → Scripts de base de datos scripts/ → Scripts de automatización/configuración
